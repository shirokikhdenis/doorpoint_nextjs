...
export const SEO_COPY = {
  home: {
    title: "Входные и межкомнатные двери в Архангельске — Дверная Точка",
    description:
  ...
  armaFoto: {
    title: buildPageTitle("Двери Арма под заказ"),
    description:
      "Фото дверей, изготовленных на фабрике Арма (Йошкар-Ола) под заказ. Выберите понравившуюся дверь и отправьте заявку — рассчитаем стоимость и сроки по вашим параметрам.",
  },
  privacy: {
