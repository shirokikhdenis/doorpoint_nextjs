...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/door-finishes", label: "Покрытия дверей" },
      { href: "/admin/promotions", label: "Акции на главной" },
      { href: "/admin/door-of-week", label: "Дверь недели" },
      { href: "/admin/home-sections", label: "Блоки на главной" },
      { href: "/admin/home-factory-logos", label: "Логотипы на главной" },
...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/admin/door-finishes": "Покрытия дверей",
  "/admin/promotions": "Акции на главной",
  "/admin/door-of-week": "Дверь недели",
